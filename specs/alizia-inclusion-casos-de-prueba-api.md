...
### 4.5 — TC-005 — GET /students/{id}/profile
...
### 4.6 — TC-006 — PUT /students/{id}/profile
...
### 4.7 — TC-007 — GET /students/{id}/notes
...
### 4.8 — TC-008 — POST /students/{id}/notes
...
### 4.9 — TC-009 — PUT /students/{id}/notes/{noteId}
...
### 4.10 — TC-010 — DELETE /students/{id}/notes/{noteId}
...
### 4.11 — TC-011 — DELETE /students/{id}
